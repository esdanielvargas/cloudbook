...
export default function Button({
  ...
  const base = `${
    full ? "w-full " : ""
  }h-9 px-2.5 md:px-4 min-w-max flex items-center justify-center gap-2 cursor-pointer rounded-md text-sm md:text-md tracking-wide transition-all duration-300 ease-out`;
  ...
  const variants = {
    ...
    icon: "w-9 h-9 !px-0 rounded-lg hover:bg-neutral-200/75 dark:bg-neutral-900/75 hover:dark:bg-neutral-800/75 border border-neutral-300/75 dark:border-neutral-800/75",
    filter:
