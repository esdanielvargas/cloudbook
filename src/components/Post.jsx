...
export default function Post(props) {
  ...
  return (
    <article className="w-full flex flex-col rounded-xl bg-neutral-100/75 dark:bg-neutral-900/75 border border-neutral-200/75 dark:border-neutral-800/75">
      <PostHeader {...props} postId={postId} author={author} />
      <PostContent {...props} postId={postId} premium={premium} />
      <PostAction {...props} postId={postId} author={author} saved={props?.saved} />
    </article>
  );
}
